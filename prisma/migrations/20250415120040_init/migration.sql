-- CreateEnum
CREATE TYPE "Day" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'FRIDAY');
...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_assignementId_fkey" FOREIGN KEY ("assignementId") REFERENCES "Assigment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
