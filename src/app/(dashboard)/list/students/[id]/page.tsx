    ...
    return <div className="flex flex-col xl:flex-row flex-1 p-4 gap-4  ">
        ...
        <div className="bg-white rounded-md p-4">
                ...
                <div className="flex flex-wrap mt-4 gap-4 text-gray-500 text-xs">
                    <Link className="rounded-md p-3 bg-school-blue-light" href={`/list/lessons?classId=${2}`}>Student&apos;s Lessons</Link>
                    ...
                    <Link className="rounded-md p-3 bg-school-blue-light" href={`/list/exams?classId=${2}`}>Student&apos;s Exams</Link>
                    <Link className="rounded-md p-3 bg-school-yellow-light" href={`/list/assignments?classId=${2}`}>Student&apos;s Assignments</Link>
                </div>
        </div>
        <Performance/>
        <Announcement />
